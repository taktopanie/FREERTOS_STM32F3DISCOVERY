...
#define LCD_DATA_4_PIN_Pin GPIO_PIN_0
#define LCD_DATA_4_PIN_GPIO_Port GPIOD
#define LCD_DATA_5_PIN_Pin GPIO_PIN_1
#define LCD_DATA_5_PIN_GPIO_Port GPIOD
#define LCD_DATA_6_PIN_Pin GPIO_PIN_2
#define LCD_DATA_6_PIN_GPIO_Port GPIOD
#define LCD_DATA_7_PIN_Pin GPIO_PIN_3
#define LCD_DATA_7_PIN_GPIO_Port GPIOD
#define LCD_RS_PIN_Pin GPIO_PIN_5
#define LCD_RS_PIN_GPIO_Port GPIOD
#define LCD_RW_PIN_Pin GPIO_PIN_6
#define LCD_RW_PIN_GPIO_Port GPIOD
#define LCD_E_PIN_Pin GPIO_PIN_7
#define LCD_E_PIN_GPIO_Port GPIOD
